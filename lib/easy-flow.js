...
var EasyFlow = (function () {
    function EasyFlow(configurator) {
        ...
        configurator(function (state) {
            ...
            return transition;
        }, to(false), to(true), function (event, context) {
            // trigger
            ...
            // whenEnter
            _this.handlers.push(new HandlerRecord(handler, state, 0 /* WHEN_ENTER */));
        }, function (state, handler) {
            // whenLeave
            _this.handlers.push(new HandlerRecord(handler, state, 1 /* WHEN_LEAVE */));
        }, function (event, handler) {
            // whenEvent
            _this.handlers.push(new HandlerRecord(handler, event, 2 /* WHEN_EVENT */));
        });
    }
    ...
    EasyFlow.prototype.event = function (context, event) {
        ...
        if (matchedTransition) {
            ...
            this.handlers.forEach(function (handler) {
                if (handler.type === 2 /* WHEN_EVENT */ && handler.match === event) {
                    runAsync(function () {
    ...
    EasyFlow.prototype.enter = function (context, nextState) {
        ...
        runAsync(function () {
            ...
            _this.handlers.forEach(function (handler) {
                if (handler.type === 0 /* WHEN_ENTER */ && handler.match === nextState) {
                    runAsync(function () {
    ...
    EasyFlow.prototype.leave = function (context) {
        ...
        if (context.state) {
            runAsync(function () {
                ...
                _this.handlers.forEach(function (handler) {
                    if (handler.type === 1 /* WHEN_LEAVE */ && handler.match === context.prevState) {
                        runAsync(function () {
                            handler.handler(context, context.state, context.lastEvent);
                        });
                    }
...
//# sourceMappingURL=easy-flow.js.map